        ...
        <div className="flex container justify-center">
          <div className="max-w-6xl mt-10">
            ...
            <div className=" mt-10 text-xl">
              ...
              <p className="pb-5">
                • Обладают действующим сертификатом Системы сертификации в
                области связи (№ ОС-3-СТ-0550, ТУ 4251-001-69603108-2016), и
            ...
            <div className="grid grid-cols-2 mt-10">
              <div>
                ...
                <div className=" mt-10 text-xl">
                  ...
                  <p className="pb-5">
                    • Позволяет активно управлять оборудованием связи
                    (авторизация доступа к услугам связи, прекращение соединений
                    и т.п.)
                  </p>
                  <p className="pb-5">
                    • Широкие возможности интеграции с ERP, CRM-системами, СКУД
                    и т.п.
                  </p>
                  <p className="pb-5">
